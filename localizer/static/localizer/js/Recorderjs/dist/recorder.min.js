    ...
    return function(e) {
        ...
        (function(t) {
            var n = function(e) {
                ...
                this.state = "inactive", this.eventTarget = t.document.createDocumentFragment(), this.audioContext = new t.AudioContext, this.monitorNode = this.audioContext.createGain(), this.config = Object.assign({
                    bufferLength: 4096,
                    command: "init",
                    encoderApplication: 2049,
                    encoderFrameSize: 20,
                    encoderPath: "localizer/static/localizer/js/Recorderjs/dist/encoderWorker.min.js",
            ...
            n.isRecordingSupported = function() {
                return t.AudioContext && t.navigator && (t.navigator.getUserMedia || t.navigator.mediaDevices && t.navigator.mediaDevices.getUserMedia)
                ...
                var e = this,
                    n = function(n) {
                        return e.stream = n, e.sourceNode = e.audioContext.createMediaStreamSource(n), e.sourceNode.connect(e.scriptProcessorNode), e.sourceNode.connect(e.monitorNode), e.eventTarget.dispatchEvent(new t.Event("streamReady")), n
                    },
                    o = function(n) {
